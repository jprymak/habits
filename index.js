  ...
  habitStatus.forEach((status) =>
    status.addEventListener("click", (e) => {
      ...
      if (e.currentTarget.classList.contains("habit-status--broken")) {
        ...
        repository.currentHabit.calendar[monthIndex].days[
          dayIndex
        ].maintained = true;
      } else {
      ...
      const habitMaintainedCount = repository.currentHabit.calendar[
        monthIndex
      ].days.reduce((maintainedCount, day) => {
      ...
      repository.currentHabit.calendar[
        monthIndex
      ].maintained = habitMaintainedCount;
